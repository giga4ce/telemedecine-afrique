...
## Entrées
- Questions en langage naturel des utilisateurs établissements.
- Statuts des dossiers en cours (lecture seule).

## Sorties
- Réponses conversationnelles basées uniquement sur les données de statut disponibles.
